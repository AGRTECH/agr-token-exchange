...
// This file takes this out of the redux state and formats it if needed
...
const tokenPriceClass = (tokenPrice, orderId, previousOrder) => {
  ...
  if (previousOrder.tokenPrice <= tokenPrice) {
    return GREEN; // success in bootstrap
  } else {
    return RED; // danger in bootstrap
  }
};
...
export const myOpenOrdersSelector = createSelector(
  ...
  openOrders,
  (account, orders) => {
    // Filter orders created by currect account
